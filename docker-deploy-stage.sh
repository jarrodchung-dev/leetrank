...
then
    ...
    then
        ...
        deploy_cluster() {
            ...
            cluster="flaskreactrank-staging-cluster"
            
            # USERS
            service="flaskreactrank-users-service-stage"
            ...
            update_service
            # CLIENT
            service="flaskreactrank-client-service-stage"
            ...
            update_service
            # SWAGGER
            service="flaskreactrank-swagger-service-stage"
            ...
            update_service
            # EXERCISES
            service="flaskreactrank-exercises-service-stage"
            ...
            update_service
            # SCORES
            # service="flaskreactrank-scores-service-stage"
