...
const exercises = [
  {
    id: 0,
    body: "Define a function called sum that takes two integers as arguements \
    and returns their sum."
  },
  {
    id: 1,
    body: "Define a function called reverse that takes a string as an arguement \
    and returns the string in reversed order."
  },
  {
    id: 2,
    body: "Define a function called factorial that takes a random number as an \
    arguement and then returns the factorial of that given number."
  }
];
...
test("Exercises renders a snaphost properly", () => {
  const onDidMount = jest.fn();
...
test("Exercises will call UNSAFE_componentWillMount when mounted", () => {
